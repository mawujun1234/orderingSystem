...
Ext.define('y.order.GzsOrderInsertGrid',{
...
//      	}
	  ...
	  me.store=Ext.create('Ext.data.Store',{
			...
			proxy:{
				type: 'ajax',
			    url : Ext.ContextPath+'/gzsorderinsert/queryData.do',
...
//					totalProperty:'total'		
	  ...
	  this.cellEditing.on("edit",function(editor, context){
		...
		//params.value=value;
	  	...
	  	Ext.Ajax.request({
			url:Ext.ContextPath+'/gzsorderinsert/updateOrdszdtl.do',
			params:{
				...
				suitno:grid.getStore().getProxy().extraParams.suitno,

				sampno:record.get("SAMPNO"),
				mlorno:record.get("MLORNO"),
				//sztype:record.get("SZTYPE"),
				
				//ormtqs:record.get("ORMTQT_NOW"),
				//ormtqt:record.get("ORMTQT_NOW"),
