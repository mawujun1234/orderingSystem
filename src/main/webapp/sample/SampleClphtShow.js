Ext.define('y.sample.SampleClphtShow', {
	extend : 'Ext.panel.Panel',
	requires : ['y.sample.SampleClpht'],
	...
	initComponent : function() {
		...
		me.store = Ext.create('Ext.data.Store', {
			autoLoad:false,
	        model: 'y.sample.SampleClpht',
	        proxy: {
	            type: 'ajax',
	            url: Ext.ContextPath+'/sampleClpht/queryAll.do',
	            reader: {
	                type: 'json'
	                //rootProperty: 'images'
	            }
