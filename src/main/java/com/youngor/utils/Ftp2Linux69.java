...
public class Ftp2Linux69 {
	...
	private static String linux_tomcat_install_dir="/opt/apache-tomcat-8.0.33";
	private static String linux_webapps_dir=linux_tomcat_install_dir+"/webapps";
	private static String od_file_local="E:\\eclipse\\aaa\\orderingSystem\\target\\ROOT.war";
	private static String od_file_remote=linux_webapps_dir+"/ROOT.war";
	private static String linux_od_folder=linux_webapps_dir+"/ROOT";
